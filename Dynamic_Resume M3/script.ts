      ...
      <body>
        ...
        <main>
          ...
          ${
            ...
            <p><strong>Name:</strong> ${uniName}</p>
            <p><strong>Department:</strong> ${uniDept}</p>
            <p><strong>Enroll Year:</strong> ${uniEnroll}</p>
            <p><strong>End Year:</strong> ${uniEnd}</p>
            <h3><strong>College-Info:</strong></h3>
            <p><strong>Name:</strong> ${colName}</p>
            <p><strong>Department:</strong> ${colFaculty}</p>
            <p><strong>Enroll Year:</strong> ${colEnroll}</p>
            <p><strong>End Year:</strong> ${colEnd}</p>
            <h3><strong>School-Info:</strong></h3>
            <p><strong>Name:</strong> ${schoolName}</p>
            <p><strong>End Year:</strong> ${schoolEnd}</p>
            </section>
